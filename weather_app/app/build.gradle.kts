...
//    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.4.0-alpha05")
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.7.0") // some version of this
...
//    implementation("androidx.compose.runtime:runtime:1.6.1")
    implementation("androidx.compose.runtime:runtime-livedata:1.6.1") // he has this one
